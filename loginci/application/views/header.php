...
<head>
	<meta charset="utf-8">
	<title>OverGroup - Find Overwatch Players</title>
	...
	<div class="header">
		<nav>
			...
			<div class="user-nav">
				...
				<a href="<?php echo site_url('login/register#register') ?>"><button class="register"><i class="fa fa-user-plus" aria-hidden="true"></i>Register</button></a>
			</div>
		</nav>
	</div>
